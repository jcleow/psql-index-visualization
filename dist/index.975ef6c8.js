...
${frame.code}`;
    ...
    "8lqZg": [
      function (require, module, exports) {
        ...
        var _index2Json = require("../index_2.json");
        var _index2JsonDefault = parcelHelpers.interopDefault(_index2Json);
        const labels = [
          "index_scans_count",
        ...
        const createChart = (label) => {
          new (0, _autoDefault.default)(document.getElementById(`${label}`), {
            type: "bar",
            data: {
              labels: (0, _index2JsonDefault.default).map(
                (row) => row.index_name
              ),
              datasets: [
                {
                  label: label,
                  data: (0, _index2JsonDefault.default).map(
                    (row) => row[label]
                  ),
                },
              ],
          ...
          console.log(
            (0, _index2JsonDefault.default).map((row) => row[label]),
            label
          );
        };
        (async function () {
      ...
      {
        "chart.js/auto": "cdrfl",
        "@parcel/transformer-js/src/esmodule-helpers.js": "hMyTC",
        "../index_2.json": "cnUKQ",
      },
    ],
    cdrfl: [
      function (require, module, exports) {
        ...
        var _chartJs = require("./chart.js.js");
    ...
    hfCwg: [
      function (require, module, exports) {
        ...
        var _helpersSegmentJs = require("./chunks/helpers.segment.js.js");
        ...
        class Scale extends Element {
          ...
          _callHooks(name1) {
            ...
            (0, _helpersSegmentJs.Q)(this.options[name1], [this]);
          }
          beforeDataLimits() {
        ...
        var plugin_legend = {
          ...
          descriptors: {
            ...
            labels: {
              _scriptable: (name1) =>
                !["generateLabels", "filter", "sort"].includes(name1),
            },
          },
        };
        ...
        function invokeCallbackWithFallback(callbacks, name1, ctx, arg) {
          ...
          if (typeof result === "undefined")
            return defaultCallbacks[name1].call(ctx, arg);
          return result;
        }
        class Tooltip extends Element {
          ...
          _drawColorBox(ctx, pt, i, rtlHelper, options) {
            ...
            if (options.usePointStyle) {
              ...
              ctx.lineWidth = (0, _helpersSegmentJs.i)(labelColors.borderWidth)
      ...
      {
        "./chunks/helpers.segment.js": "ixmVy",
        "@kurkle/color": "lizAe",
        "@parcel/transformer-js/src/esmodule-helpers.js": "hMyTC",
      },
    ],
    ixmVy: [
      function (require, module, exports) {
         ...
         * @typedef { import('../core/core.controller.js.js').default } dom.Chart
    ...
    cnUKQ: [
      function (require, module, exports) {
        module.exports = JSON.parse(
          '[{"table_name":"tb_lead","index_name":"ix_tb_lead_cluster_id","index_scans_count":119778703,"index_scan_tuple_read":6831518622,"index_scan_tuple_fetch":18350,"index_size":"11 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_unit_num","index_scans_count":88818981,"index_scan_tuple_read":138367040675,"index_scan_tuple_fetch":9489,"index_size":"11 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_hdb_x_value","index_scans_count":49598009,"index_scan_tuple_read":144353483,"index_scan_tuple_fetch":110263987,"index_size":"15 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_condo_x_value","index_scans_count":36438840,"index_scan_tuple_read":122432862,"index_scan_tuple_fetch":68967982,"index_size":"12 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_landed_x_value","index_scans_count":7244107,"index_scan_tuple_read":2044704361,"index_scan_tuple_fetch":10902022,"index_size":"1576 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_floor_num","index_scans_count":6822169,"index_scan_tuple_read":45433077049,"index_scan_tuple_fetch":431488,"index_size":"11 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_latest_transaction","index_scans_count":1905769,"index_scan_tuple_read":1889350,"index_scan_tuple_fetch":622778,"index_size":"45 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_lead_contact_id","index_scans_count":245928,"index_scan_tuple_read":2915264,"index_scan_tuple_fetch":2534955,"index_size":"9936 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_select_x_value","index_scans_count":208384,"index_scan_tuple_read":1096878819,"index_scan_tuple_fetch":51196,"index_size":"57 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_cea_number","index_scans_count":74062,"index_scan_tuple_read":26021946,"index_scan_tuple_fetch":8040,"index_size":"9032 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_id_is_hidden","index_scans_count":69718,"index_scan_tuple_read":451326,"index_scan_tuple_fetch":406185,"index_size":"31 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead_files","index_name":"ix_tb_lead_files","index_scans_count":35643,"index_scan_tuple_read":11600,"index_scan_tuple_fetch":11572,"index_size":"16 kB","table_reads_index_count":35643,"table_reads_seq_count":2403,"table_reads_count":38046,"table_writes_count":356,"table_size":"40 kB"},{"table_name":"tb_lead_user_templates","index_name":"ix_tb_lead_user_templates","index_scans_count":5438,"index_scan_tuple_read":96068,"index_scan_tuple_fetch":2754,"index_size":"48 kB","table_reads_index_count":48532,"table_reads_seq_count":4348,"table_reads_count":52880,"table_writes_count":1240,"table_size":"128 kB"},{"table_name":"tb_lead_messages","index_name":"ix_tb_lead_messages_id","index_scans_count":4811,"index_scan_tuple_read":4432,"index_scan_tuple_fetch":3923,"index_size":"72 kB","table_reads_index_count":5202,"table_reads_seq_count":489,"table_reads_count":5691,"table_writes_count":1544,"table_size":"312 kB"},{"table_name":"tb_lead","index_name":"idx_leads_lead_contact_id","index_scans_count":2569,"index_scan_tuple_read":133624,"index_scan_tuple_fetch":112324,"index_size":"9960 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"idx_leads_cea_number","index_scans_count":1903,"index_scan_tuple_read":779214,"index_scan_tuple_fetch":0,"index_size":"8872 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_cea_number_district_main_cat","index_scans_count":1757,"index_scan_tuple_read":197732,"index_scan_tuple_fetch":6056,"index_size":"18 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_cea_number_mop_ssd_expiry_date","index_scans_count":807,"index_scan_tuple_read":352008,"index_scan_tuple_fetch":131957,"index_size":"24 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead_contact","index_name":"ix_tb_lead_contact_contact_display_name","index_scans_count":394,"index_scan_tuple_read":18295,"index_scan_tuple_fetch":0,"index_size":"4584 kB","table_reads_index_count":53327,"table_reads_seq_count":59731,"table_reads_count":113058,"table_writes_count":28471,"table_size":"3768 kB"},{"table_name":"tb_lead_messages","index_name":"ix_tb_lead_messages_user","index_scans_count":391,"index_scan_tuple_read":680,"index_scan_tuple_fetch":375,"index_size":"144 kB","table_reads_index_count":5202,"table_reads_seq_count":489,"table_reads_count":5691,"table_writes_count":1544,"table_size":"312 kB"},{"table_name":"tb_lead_section_notes","index_name":"ix_tb_lead_section_notes","index_scans_count":368,"index_scan_tuple_read":724,"index_scan_tuple_fetch":14,"index_size":"16 kB","table_reads_index_count":505,"table_reads_seq_count":2104,"table_reads_count":2609,"table_writes_count":266,"table_size":"16 kB"},{"table_name":"tb_lead","index_name":"idx_tb_lead_latest_transaction_date","index_scans_count":22,"index_scan_tuple_read":8964,"index_scan_tuple_fetch":0,"index_size":"29 MB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead","index_name":"ix_tb_lead_is_hidden","index_scans_count":8,"index_scan_tuple_read":839372,"index_scan_tuple_fetch":691303,"index_size":"9912 kB","table_reads_index_count":467074024,"table_reads_seq_count":190002,"table_reads_count":467264026,"table_writes_count":510220858,"table_size":"917 MB"},{"table_name":"tb_lead_contact","index_name":"tb_lead_contact_lead_arm_id","index_scans_count":0,"index_scan_tuple_read":0,"index_scan_tuple_fetch":0,"index_size":"216 kB","table_reads_index_count":53327,"table_reads_seq_count":59731,"table_reads_count":113058,"table_writes_count":28471,"table_size":"3768 kB"},{"table_name":"tb_lead_group","index_name":"ix_tb_lead_group_name","index_scans_count":0,"index_scan_tuple_read":0,"index_scan_tuple_fetch":0,"index_size":"40 kB","table_reads_index_count":144,"table_reads_seq_count":1078,"table_reads_count":1222,"table_writes_count":123,"table_size":"8192 bytes"}]'
        );
      },
      {},
    ],
